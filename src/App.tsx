      ...
      <div className="w-full max-w-lg min-h-screen sm:h-screen flex flex-col pt-4 pb-0 px-8 relative z-20 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center overflow-hidden">
          ...
          <div className="flex flex-col items-center shrink-0 mb-4 mt-6">
            <div className="bg-[#E6E6FA] rounded-2xl w-[220px] h-[74px] flex items-center justify-center mb-1 shadow-sm border border-white/50">
          ...
          <div className="w-[calc(100%+40px)] space-y-3 bg-white/95 backdrop-blur-md rounded-[3rem] pt-[27px] pb-[65px] px-8 border border-white/20 shrink-0 mx-[-20px] mt-6">
