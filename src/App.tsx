    ...
    <div className="min-h-screen w-full flex items-center justify-center overflow-hidden relative bg-gray-900">
      ...
      <div className="w-full max-w-lg min-h-screen sm:h-screen flex flex-col pt-4 pb-[46px] px-8 relative z-20 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center overflow-hidden">
          ...
          <div className="w-[calc(100%+40px)] space-y-3 bg-white/95 backdrop-blur-md rounded-[3rem] pt-[27px] pb-[51px] px-8 shadow-2xl border border-white/20 shrink-0 mx-[-20px] mt-6">
